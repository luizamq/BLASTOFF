...
//feito por: Luiza Moruz em 20/10/2021
...
//Obs: no Playground é impossível ler um input, nesse caso, o input seria a temperatura em Celsius que se quer transformar. Para esse caso, determinei 40 graus Celsius para fazer o algoritmo.
...
if palavra == palavraContrario {
    ...
    // Oi, time Toodoo! Obrigada pela oportunidade de fazer esse desafio! Achei desafiador na medida certa e até divertido de fazer! :)
